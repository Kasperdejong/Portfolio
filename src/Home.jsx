...
function Home() {
    ...
    return (
        <header
            className="relative bg-[url(/Portfolio/artsy-background.jpg)] bg-cover bg-center bg-no-repeat min-h-screen w-full flex flex-col items-center">
            <Blob2/>
            ...
            <div
                className="flex flex-col lg:flex-row items-center justify-center max-w-screen-xl w-full gap-10 p-4 mt-20 sm:mt-16 md:mt-24">
                <div
                    className="bg-red-600 border-gray-800  border-2 text-white p-6 rounded-lg shadow-lg w-full lg:w-1/2">
                    ...
                    <h2 className="text-xl font-semibold pt-6">Wat zoek ik?</h2>
                    <p className="">
                        Ik zoek een <b>stage</b> voor <b>frontend development</b>. Het liefst een plek waar ik mijn
                        creativiteit kan uiten en goed aan de slag kan gaan.
                    </p>
                </div>

                <div
                    className="w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-72 lg:h-72 bg-[url(/Portfolio/Closeupfoto.jpg)] border-black bg-cover bg-center rounded-full flex-shrink-0"></div>
            </div>

            <div className="relative w-full flex flex-col items-center">
                <Blob/>
                <h2 className="text-red-600 z-10 text-2xl sm:text-3xl md:text-4xl p-8 font-bold text-center drop-shadow-[2px_2px_0px_black]">Mijn
                    Skills</h2>

                {/* Frontend Skills */}
                <div className="mb-8 w-11/12 md:w-3/4">
                    <h3 className="text-red-600 drop-shadow-[1px_1px_0px_black] text-xl sm:text-2xl font-semibold mb-4">Frontend
                        Development</h3>
                    <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
                        {frontendSkills.map((skill) => (
                            <a key={skill.name} href="/Portfolio/projecten" className="no-underline">
                                <div key={skill.name}
                ...
                {/* Backend Skills */}
                <div className="mb-8 w-11/12 md:w-3/4">
                    <h3 className="text-red-600 drop-shadow-[1px_1px_0px_black] text-xl sm:text-2xl font-semibold mb-4">Backend
                        Development</h3>
                    <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
